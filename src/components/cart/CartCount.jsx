    ...
    <>
      <div className="bg-white h-11 flex items-center justify-between px-3 sticky top-0 left-0 right-0 w-full">
        ...
        <div className="flex items-center">
          <button type="button" onClick={onClearCart} className="rounded bg-theme-cart active:scale-90 p-0.5">
            <XMarkIcon className="w-5 h-5 cursor-pointer text-white stroke-[2]" />
          </button>
        </div>
      </div>
    </>
